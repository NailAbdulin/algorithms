...
public class Sorting {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Среднее время сортировка выбором: " + timeForSelectionSort + " мс. ");
        double timeForInsertionSort = timeForSorting(5, Sorting::sortInsertion);
        System.out.println("Среднее время сортировка вставками: " + timeForInsertionSort + " мс. ");
    }
